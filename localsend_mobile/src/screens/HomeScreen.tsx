        ...
        <View style={styles.radarSection}>
          ...
          <Text
            style={[
              styles.scanLabel,
              {
                color: isNoWifi ? colors.warning : colors.textSecondary,
                fontSize: t.sizes.sm,
              },
            ]}
          >
          ...
          {!isScanning && devices.length === 0 && (
            ...
            >
              ...
              <Text
                style={[
                  styles.emptyTitle,
                  { color: colors.text, fontWeight: t.weights.semibold },
                ]}
              >
                Sin dispositivos
              </Text>
              ...
              >
                Asegurate de estar en la misma red Wi-Fi que la app de
                escritorio
              </Text>
            </View>
          )}
            ...
            <View style={styles.pickerRow}>
              ...
              >
                ...
                <Text
                  style={[
                    styles.pickerLabel,
                    { color: colors.text, fontSize: t.sizes.sm },
                  ]}
                >
                  Documento
                </Text>
